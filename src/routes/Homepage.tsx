  ...
  return (
    <div className="flex-col w-full pb-24">
      <Container>
        ...
        {/* image section */}
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[480px] drop-shadow-md overflow-hidden relative">
          <img
          ...
          <div className="hidden md:block absolute w-80 bottom-4 right-4 px-4 py-2 rounded-md bg-white/60 backdrop-blur-md">
            ...
            Enhance your interview skills with our AI-powered mock interview platform, providing real-time feedback and performance analysis to help you succeed.
            </p>
